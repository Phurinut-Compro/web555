...
<header class="sticky-header">
    <div class="header-container">
        ...
        <input type="text" name="query" id="search-input" placeholder="ค้นหาสินค้า..." required>
    ...
    foreach ($product_types as $type) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<button type='submit' class='add-to-cart'>เพิ่มไปยังตะกร้า</button>";
                echo "</form>";
                echo "<button class='more-details' onclick=\"window.location.href='product_details.php?id=" . $row['product_id'] . "'\">รายละเอียดเพิ่มเติม</button>";
